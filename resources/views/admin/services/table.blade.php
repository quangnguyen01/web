    ...
    <div class="row main-card mb-3 card">
        <div class="container">
            <div class="card-body">
                <div class="row">
                    <div class="col-4">
                        <h2 class="">Danh sách dịch vụ</h2>
                    </div>
                    <div class="col-8">
                        <form id="filterForm">
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left mb-2">
                            <a class="btn btn-success" href="{{route('createService')}}">Thêm mới <i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <table class="mb-0 table table-bordered">
                    ...
                    @foreach ($services as $service)
                        <tr>
                            ...
                            <td>{{ $service->name }}</td>
                            <td><img src="{{ $service->image}}" height="75" width="75" alt="" /></td>
                            <td>
                                <a class="btn btn-primary mr-2" href="{{route('editService', $service->id)}}"><i class="fas fa-edit"></i></a>
                                <a type="submit" href="{{route('deleteService', $service->id)}}"
